...
<div class="jquery-script-clear">
	<div class="header">
  		<h1><?=$this->about_model->get_by_nama('program')->row()->value;?></h1>
	</div>
</div>
</div>
</div>
...
<div>
  <h1 class="title">Survei <?=$this->about_model->get_by_nama('program')->row()->value;?></h1><br>
...
(function (survey, $) {
    ...
    survey.generateQuestionElement = function(question) {
        ...
        if ( question.type === 'single-select' ) {
            ...
            questionAnswerElement.append('<input type="text" value="" class="text" name="' + question.id + '" placeholder="Umur...">');
        }
        else if ( question.type === 'text-field-large' ) {
