...
<form action="<?=base_url('master/macamcutisave');?>" method="post" id="formcuti">
        ...
        <!-- Custom tabs (Charts with tabs)-->
            <div class="nav-tabs-custom">
                ...
                <div class="box-header">
                    ...
                    <h3 class="box-title">Macam Cuti</h3>
                </div>
                        ...
                        <div class="row">
                            ...
                            <label>Nama</label>
                    			<div class="input-group">
                    			  <input name="nama" type="text" class="form-control pull-right" id="nama" value="<?=(isset($macamcuti->nama))?$macamcuti->nama:'';?>"/>
                    			</div>
                       		</div>
                    </div>
                    <div class="row">
                            ...
                            <label>Lama (Hari)</label>
                    			<div class="input-group">
                    			  <input name="lama" type="text" class="form-control pull-right" id="lama" value="<?=(isset($macamcuti->lama))?$macamcuti->lama:'';?>"/>
                    			</div>
                       		</div>
                    </div>
                  </div>
            ...
            <!-- end loading -->
                ...
                <div class="box-footer clearfix">
                    ...
                    <input name="id" type="hidden" id="id" value="<?=(isset($macamcuti->id))?$macamcuti->id:0;?>" />
                </div>
            </div>
                </div>
