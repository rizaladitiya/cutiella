...
<form action="<?=base_url('master/tembusansave');?>" method="post" id="formcuti">
        ...
        <!-- Custom tabs (Charts with tabs)-->
                        ...
                        <div class="row">
                            ...
                            <label>Nama</label>
                    			<div class="input-group">
                    			  <input name="nama" type="text" class="form-control pull-right" id="nama" value="<?=(isset($tembusan->nama))?$tembusan->nama:'';?>"/>
                    			</div>
                       		</div>
                    </div>
                  </div>
            ...
            <!-- end loading -->
                ...
                <div class="box-footer clearfix">
                    ...
                    <input name="id" type="hidden" id="id" value="<?=(isset($tembusan->id))?$tembusan->id:0;?>" />
                </div>
            </div>
                </div>
