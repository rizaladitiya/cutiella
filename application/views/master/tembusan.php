...
<div class="box-tools">
                <div class="input-group input-group-sm" style="width: 150px;">
                  ...
                  <form action="<?=base_url('master/tembusanupdate');?>" method="post" id="formtembusan">
				...
				<table id="my-grid" class="table table-striped table-bordered">
                    ...
                    <tbody>
                    	...
                    	<tr>
							<td><?=$no;?></td>
                            <td><?=$tembusan->nama;?></td>
                            <td class='no-sort'><a href="<?=base_url('master/tembusanupdate')."/".$tembusan->id;?>" class="fa fa-pencil">&nbsp;</a></td>
							<td class='no-sort'><a href="<?=base_url('master/tembusandelete')."/".$tembusan->id;?>" class="fa fa-trash">&nbsp;</a></td>
