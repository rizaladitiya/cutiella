		...
		<div class="panel-body">
			<div class="box-tools">
                <div class="input-group input-group-sm" style="width: 150px;">
                  ...
                  <form action="<?=base_url('master/karyawanupdate');?>" method="post" id="formkaryawan">
				...
				<table id="my-grid" class="table table-striped table-bordered">
                    ...
                    <tbody>
                    	...
                    	<tr>
                            ...
                            <td><?=$karyawan->nama;?></td>
                            <td><?=$karyawan->nip;?></td>
                            <td><?=$karyawan->awalkerja;?></td>
                            <td><?=$karyawan->jabatan;?></td>
                            <td><?=$karyawan->unitkerja;?></td>
                            <td><?=$karyawan->gelar;?></td>
                            <td><?=$karyawan->pangkat;?></td>
							<td class='no-sort'><a href="<?=base_url('master/karyawanupdate')."/".$karyawan->id;?>" class="fa fa-pencil">&nbsp;</a></td>
							<td class='no-sort'><a href="<?=base_url('master/karyawandelete')."/".$karyawan->id;?>" class="fa fa-trash">&nbsp;</a></td>
