    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
            ...
            <li class="treeview <?=$this->uri->segment('1')=="master"?'active':'';?>">
                ...
                <ul class="treeview-menu">
                	<li class="<?=$this->uri->segment('2')=="karyawan"?'active':'';?>"><a href="<?php echo site_url('master/karyawan') ?>"><i class="fa fa-user"></i> Pegawai</a></li>
                    <li class="<?=$this->uri->segment('2')=="macamcuti"?'active':'';?>"><a href="<?php echo site_url('master/macamcuti') ?>"><i class="fa fa-calendar-o"></i>Jenis Cuti</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu" <?=tidaksembunyi($user)?>>
